...
[mcitem-recipe] - Inserts a crafting table that will display what items are needed to craft the current item.
[mcitem-stats] - Inserts a table listing the stats of the item such as Points of Protection, Health, Durability, etc...
[mcitem-sources] - Inserts a table with mini-item images of the item/monster that the current item comes from.
